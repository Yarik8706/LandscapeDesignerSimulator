...
- Плагины Firebase (Assets/Firebase, ExternalDependencyManager и платформенные библиотеки в Plugins) удалены из проекта; `FirebaseInitializer` теперь служит только локальным событием без зависимости от SDK.
